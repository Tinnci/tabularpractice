...
export interface SemanticCircuitDiagramProps {
...
/**
 * SemanticCircuitDiagram - ELK-powered circuit visualization
 */
export function SemanticCircuitDiagram({
    config,
    height = 300,
    className,
}: SemanticCircuitDiagramProps) {
